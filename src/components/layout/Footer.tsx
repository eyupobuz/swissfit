  ...
  return (
    <a
      ...
      style={{
        ...
        height: 38,
        borderRadius: "50%",
        border: `1px solid ${hov ? RED + "88" : "#222"}`,
        background: hov ? RED + "18" : "transparent",
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        color: hov ? RED : "#3a3a3a",
        transition: "all .2s",
        cursor: "pointer",
      }}
  ...
  >
    ...
    <div
      style={{
        ...
        inset: 0,
        backgroundImage:
          "repeating-linear-gradient(0deg,transparent,transparent 3px,#e8272705 3px,#e8272705 4px)",
    ...
    >
      ...
      >
        <p style={{ fontFamily: ffM, fontSize: 10, color: "#2e2e2e", letterSpacing: "0.08em" }}>
          © {new Date().getFullYear()} SWISS FIT CLUB. TÜM HAKLARI SAKLIDIR.
        </p>
        <p style={{ fontFamily: ffM, fontSize: 10, color: "#2e2e2e", letterSpacing: "0.1em" }}>
